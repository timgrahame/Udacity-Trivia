...
def create_app(test_config=None):
  ...
  def after_request(response):
    ...
    return response
# ------------------------------------------------Paginate Questions----------------------------------------------------------------------------------------
# Create Paginate Questions function
...
# ------------------------------------------------Get Categories-----------------------------------------------------------------------------------------------
  ...
  def delete_questions(question_id):
    #get question that matches question_ID in endpoint and if exists, delete else 404
    try:
  ...
  def search_questions():
    ...
    #search for items that are like the search_term and populate current_question with found questions.
    try:
  ...
  def play_quiz_question():
    ...
    #check that to see if chosen question id exists in previous_question list and if so, get_question again.
  ...
  def internal_server_error(error):
      return jsonify({
          'success': False,
          'error': 500,
          'message': 'An error has occured, is the server running?  Are you sure?'
      }), 500

  # Error handler for unprocesable (422)
  @app.errorhandler(422)
  def unprocessable_entity(error):
      return jsonify({
          'success': False,
          'error': 422,
          'message': 'Sorry, due to me being semantic this request can not be processed'
      }), 422
